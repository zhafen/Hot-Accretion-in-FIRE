...
quantity_labels = {
    ...
    'disk_frac': r'aligned accretion fraction,  $f_{\rm aligned}$',
    'delta_disk_frac': r'$\Delta$(aligned accretion), $\Delta f_{\rm aligned}$',
    'jdisk_frac': r'aligned accretion fraction, $f_{\rm aligned,\,j}$',
    'delta_jdisk_frac': r'$\Delta$(aligned accretion), $\Delta f_{\rm aligned,\,j}$',
    'smooth_disk_frac': r'aligned accretion fraction,  $f_{\rm aligned}$',
