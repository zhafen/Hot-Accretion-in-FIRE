...
(i) hot gas dominates the inflowing gas mass, accounting for $\sim4/5$ of the mass;
...
This rotational support is responsible for the stalling seen in panel (B), and is a feature of many simulations of $L^*$ halos~\citep[][]{Oppenheimer2018}.
}
...
\begin{itemize}
    \item Quiet accretion is the expected accretion mode for volume-filling infalling gas~(\S\ref{s: broader prevalence}).
