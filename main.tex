...
Add comment about the degeneracy/compleminterarty(?) of increased density and running into the pre-existing gas.
A confusing part to some (e.g. Alex) is how the pole-gas interacts with others.
