...
\textbf{Try limiting plot B to 0.5.}
\textbf{Fraction of gas converted to stars. (Use words.)}
\textbf{Add velocity panel, re-order.}
}
...
\begin{figure*}
    ...
    \textbf{Move rightmost panel to the appendix.}
    }
