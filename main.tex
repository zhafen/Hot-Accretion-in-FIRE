...
The gas then starts forming stars shortly after cooling (Fig.~\ref{f: before and after A}). Note that star formation occurs despite that the 84th density percentile after cooling is $\approx10$ cm$^{-3}$, well below the minimum density for star formation of $n_{\rm SF} = 1000$ cm$^{-3}$ in FIRE, since gas remains at densities approaching $n_{\rm SF}$ only for a short time before forming stars.
...
\begin{figure*}
    ...
    \caption{
    Median properties relative to time of accretion for thin disk galaxies (red; $\fthin>0.5$) and irregular galaxies (blue; $\fthin<0.5$).
...
We show the properties of \texttt{m12f} as a function of time in Appendix~\ref{s: appendix-individual}, and exclude its contribution to the medians in Figure~\ref{f: before and after combined}..
...
\section{Accretion onto \texttt{m12f}}
...
Prior to reaching radii and densities required to fit our definition of $\tacc$, accretion in \texttt{m12f} is already cooler and more aligned relative to other thin disk galaxies.
}
\label{f: m12f-tacc}
\end{figure*}
