...
\begin{figure*}
    ...
    \textbf{Bottom:} 10 T vs.\ R and K vs.\ R tracks for two $L^\star$ halo at $z=0$, with color indicating time relative to the time at which gas cools.
    ...
    \textbf{This plot should be complemented in the prevalence section with a plot that shows the distribution for more simulations.}
    }
    \label{f: T vs R}
\end{figure*}
...
\textbf{Non-md simulations have unexpected cooling at large radii, according to Jonathan. This would be good to cite here.}
