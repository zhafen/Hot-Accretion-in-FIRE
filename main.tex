...
\title[Cooling flows and thin galactic disks]{Thin galactic disks assembled from rotating cooling-flow accretion}
...
These characteristics are the result of a \textit{cooling spiral}---a rotating cooling flow that circularizes and cools at the galaxy edge.
In a cooling spiral gas inflows until its angular momentum halts progress.
During the journey the variability of angular momentum direction decreases strongly.
When the cooling spiral becomes rotationally supported it experiences increased radiative cooling and decreased compressive heating, and the now-aligned gas rapidly collapses into a disk.
The presence of a cooling spiral is strongly correlated with thin disk formation:
in galaxies with thin disk fractions $>0.7$ over half the accreting gas mass becomes aligned with the thin disk within 150 Myrs of cooling.
...
% I opted for "cooling spiral" as the term to use. I discuss why I chose that because it captures the important parts of "circularizing cooling flow" or "rotating cooling flow", but is shorter and more memorable.
...
\textbf{Right:} Positions of all gas particles before and after they cool, colored by temperature.
...
% \caption{
% I-band surface brightness profile for an edge-on stellar disc.
% Black line (shaded region) is the median (16th-84th percentile) brightness among pixels 7.5 kpc above/below the disc.
% The disc truncates at $\approx 12$ kpc, as seen by the sharp drop-off in the brightness for the percentiles, consistent with observations.
% \textbf{
...
\textbf{Why is delta PDF so much better of a predictor of thin disc fraction, compared to ones that are ratio of PDF or involve the larger distribution?}
...
I think it's that Delta PDF is most-strongly correlated with quiet accretion fraction, which might predict thin disc fraction.
...
% Not overly centered on disc formation
...
% Previous idealized simulations have studied cool gas clouds condensing onto galaxies and found that disrupted and heated clouds could condense and cool at disc edge~\citep{Heitsch2009}.
...
% de Jong+07: Stellar Populations across the NGC 4244 Truncated Galactic disc
...
% Norbert Werner sees the X-ray atmosphere is flattened, along the disc.
...
% % Radial Inflow
% \textbf{
% Observational estimates of disc rotation:
...
%     \item The accreting gas forms a coherent disc as it cools, prior to which it is distributed quasi-spherically~(\S\ref{s: characteristics -- aligns}).
% \end{enumerate}
...
% The name ``quiet accretion'' reflects both the challenge in detecting the hot, low-density gas prior to cooling (\textbf{Good citations for this?}), and the ``soft-landing'' of the coherent disc gas onto the galaxy (more in \S\ref{s: disc formation}).
...
% Second, while the accreting gas should form a coherent disc as it cools, our definition does not require it to be aligned with the galaxy.
% Quiet accretion may still occur for halos with angular momentum significantly misaligned with the galaxy, and analysis of cosmological simulations suggests that misaligned CGMs can produce warped, misaligned, or counter-rotating discs~\citep[e.g.][]{Roskar2010, Starkenburg2019}.
...
% The range in specific angular momentum values sets a range in radii at which gas stalls and cools, while still becoming fully aligned with the disc.
% \textbf{
...
% Organization into disc: angular momentum exchange
\textbf{
...
%  Organization into disc: cooling mechanism
...
% In the EAGLE simulations specific angular momentum is not conserved for cooling gas, including for gas cooling onto discy galaxies~\citep{Stevens2017}.
...
% \cite{Stevens2017} also find that gas will orient itself parallel to the cold disc as it cools.
% }
...
% Thin stellar disc but no feedback
...
% Underprediction of thin discs at low mass
...
% Database of edge-on disc galaxies
% \textbf{
...
% \textbf{
% Ho upcoming survey:
% 18 sightlines around disc galaxies.
...
% As for nearby galaxies, the H I gas of NGC 2403 moves radially inward at 10-20 km/s (Fraternali et al. 2002), and the Si IV absorbing gas in M33 has a modeled vertical accretion speed of 110 km/s at the disc-halo interface (Zheng et al. 2017).
% }
