...
\begin{figure*}
    ...
    \textbf{Change disk distribution to disk plane.}
    \textbf{Remove "contains approx 60" label.}
    }
    \label{f: theta vs t}
\end{figure*}
...
\begin{figure*}
    ...
    \textbf{Make legend alpha more opaque or increase in size.}
    \textbf{Highlight the empty corner?}
    \textbf{Change label to t(T=1e5K)?}
    }
    \label{f: prevalence}
\end{figure*}
...
\begin{figure*}
    ...
    \textbf{Have consistent colorbar and $Delta f_{\rm aligned}$ limits.}
    \textbf{Add 1e10 and logarithmic ticks in Mstar panel.}
    }
