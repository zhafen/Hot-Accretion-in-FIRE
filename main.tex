...
\begin{figure*}
    ...
    \textbf{
    Make labels bigger.
    Remove $t-\tcools$ from labels.
    Maybe add a line to the circle.
    }
    }
...
This is explained by $t_{\rm cool}/t_{\rm ff} \sim 1-100$ in the inflowing hot CGM, i.e. gas accretes onto the galaxy faster than a cooling instability spontaneously develops~\citep{Balbus1989}.
...
\begin{figure*}
    ...
    \caption{
    Fraction of young stars in a thin disk versus spin parameter $\lambda$, ratio of specific angular momentum of thin disk stars to that of the dark matter halo, ratio of specific angular momentum of all stars to that of the dark matter halo, and change in alignment of accreting gas (see Figure~\ref{f: prevalence}).
    We see no correlation between thin disk fraction and spin parameter
    }
