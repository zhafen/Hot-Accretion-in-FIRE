...
In \S\ref{s: fueling} and \S\ref{s: disk formation} we discuss the implications of quiet accretion for fueling star formations and encouraging disk formation, respectively.
...
\subsubsection{Aligns as it cools}
...
\subsubsection{Cools after circularizing}
...
% Argue primary mode for MW-mass halos

% Prevalent in FIRE simulations
...
\subsubsection{Analogous accretion for halos with non-thermal support}
...
\textit{
The FIRE simulations overpredict the observed SFR in MW-mass halos by a factor of $\sim 4$ \textbf{citation needed}.
}

% Maximum amount of possible fuel

\textbf{Look at \cite{Dekel2014}.}

\textbf{Jonathan SFR discussion on slack.}

\subsection{Quiet accretion and disk formation}
\label{s: disk formation}

\subsubsection{There is a bifurcation in galaxy and CGM properties.}

% Causal direction of  bursty transition
\textbf{
...
https://ui.adsabs.harvard.edu/abs/2019MNRAS.486..215S/abstract}

\textbf{
Could HVCS be an HI warp?
https://ui.adsabs.harvard.edu/abs/2006ApJ...643..881L/abstract
}
...
https://ui.adsabs.harvard.edu/abs/2003ApJS..146..165S/abstract
...
\textbf{Halo21 KITP workshopw/ KITP primary grant number NSF PHY-1748958.
