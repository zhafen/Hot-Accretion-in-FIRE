...
\textit{
The selection criteria also selects particles that are duplicates of those in the galaxy and were previously in the CGM, as well as particles that are in the galaxy and are duplicates of particles in the CGM, and also all particles that are duplicates prior and afterwards.
}
% \textit{
...
\begin{figure*}
    ...
    \textbf{
    Try making a 2D histogram of \Rcool and the angle at which it accretes.
    }
