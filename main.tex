...
% Another implication of the smooth accretion onto a disk in rotating cooling flows is that the accreting gas does not inject into the ISM the momentum it gained while falling in the halo potential well.
...
% Their analysis focused on simulations that include cosmic ray feedback
...
% the pressure-supported gas exchanges momentum and energy at a faster rate than it accretes.
% In the CR halo this is enabled by 
...
If rotating cooling flows % or its analogs 
are indeed a requirement for forming thin disks, then we expect thin disks mainly in relatively massive star-forming galaxies in which the CGM has virialized or is composed of subsonic gas, and at low redshift where cold flows are not expected to dominate the accretion.
...
% \cite{Trapp2021} studied the properties of accretion onto and through thin disk galaxies in CR-dominated halos in more detail, while \cite{Chan2021} studied pressure balance and outflows in the disk-halo interface.
