...
\textbf{Change panel C label to "puffy to thin".}
\textbf{Consider re-ordering to tell the story better.}
}
...
% Coronal mixing
\cite{Marinacci2010} propose that gas accretion onto the galaxy can be induced by cold clouds launched into the corona, which induce cooling of corona gas as they mix with the corona.
...
In our MW-like halos the average SFR over $z=0-0.5$ is $\approx 3-10 M_\odot/$yr, while the observationally derived average SFR for $M_{\rm vir}=10^{12} M_\odot$ halos over the same redshift range is $\approx 0.7-6 M_\odot/$yr.
