...
%\title[]{Rotating cooling flows and the physics of thin-disk galaxy formation}
...
\begin{figure*}
    ...
    \textbf{Add additional labels.}
    \textbf{This is not the message we want to share.}
    \textbf{The m11 seems incompatible with figure 3. I need to double check my $\Rcon$ calculation.}
    \textbf{m11i,c,q,a are all good choices}
    \textbf{Try absolute units.}
...
\begin{figure*}
    ...
    \textbf{Change label from 2/3 to actual fraction.}
    \textbf{Change axis label to costheta=z/R}
    }
    \label{f: theta vs t}
\end{figure*}
...
\begin{figure*}
    ...
    \textbf{in the legend add '150 Myr' before the 'before' and 'after'}
\textbf{maybe shift a bit some of the galaxies in the x-axis to avoid overlap}
...
\begin{figure*}
    ...
    \textbf{Consider swapping aligned accretion with fthin disk.
    Motivation: much better for those who think more about thin disk fraction than aligned accretion.
}
    }
