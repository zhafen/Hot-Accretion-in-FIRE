...
In the FIRE simulations these properties include a transition from a supersonic and free-falling inner CGM to a subsonic and virialized inner CGM, a transition from bursty to steady star formation, and a transition from spheroidal or thick disk to thin disk stellar morphology~(\citealt{Stern2020, Yu2021}, Gurvich et al., in prep).
}
\textbf{
\cite{El-Badry2018a}:
...
\textit{
Whether or not quiet accretion is a condition, either necessary or sufficient, for disk formation may depend on the evolution of the gas after it enters the galaxy.
However, previous cosmological simulations lacking resolved stellar feedback may provide a clue.\textbf{Bird2013, Guedes2011}
}
