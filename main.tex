...
Previous analyses that identify feedback as a promoter of disk formation ~\citep[e.g. via removal of low-angular-momentum gas][]{Brook2011, Ubler2014, Genel2015, DeFelippis2017} do not explain this transition --- as FIRE-2 galaxies evolve from bursty dwarfs to steady Milky-Way mass galaxies feedback evacuates less mass~\citep[e.g.][]{Hafen2020, Pandya2021} and winds may be confined by the CGM~\citep{Stern2021}.
...
Note that the Milky Way itself has an older thin disk population than most similar-mass FIRE simulations, and we correspondingly predict it underwent an earlier transition to steady star formation~\citep[e.g.][]{Yu2021}.
}.
...
Name  &  $\fthin$  & $M_{\rm vir}$  &  $M_\star$  &  $R_{\textrm{vir}}$  &  $\Delta f_{\rm aligned}$  &  Metal diffusion?  &  Reference  \\
  &   & $M_\odot$  & $M_\odot$  &  kpc  &  &  &  \\
 \hline
m12i  &  0.81  &  $1.1\times10^{12}$  &  $7.3\times10^{10}$  &  268  &  0.34  &  \checkmark  &  \cite{Wetzel2016}    \\
m12b  &  0.77  &  $1.3\times10^{12}$  &  $1.0\times10^{11}$  &  286  &  0.35  &  \checkmark  &  \cite{Garrison-Kimmel2019a}    \\
m12i\_core  &  0.74  &  $1.1\times10^{12}$  &  $8.0\times10^{10}$  &  274  &  0.34  &    &  \cite{Hopkins2018}    \\
m12c  &  0.66  &  $1.3\times10^{12}$  &  $6.8\times10^{10}$  &  283  &  0.25  &  \checkmark  &  \cite{Garrison-Kimmel2019a}    \\
m12f  &  0.65  &  $1.5\times10^{12}$  &  $9.7\times10^{10}$  &  302  &  0.24  &  \checkmark  &  \cite{Garrison-Kimmel2017}    \\
m12m  &  $^*$0.32  &  $1.5\times10^{12}$  &  $1.4\times10^{11}$  &  298  &  0.26  &    &  \cite{Hopkins2018}    \\
m12w  &  0.28  &  $9.5\times10^{11}$  &  $6.5\times10^{10}$  &  253  &  0.15  &  \checkmark  &  \cite{Samuel2020}    \\
m11h  &  0.27  &  $1.8\times10^{11}$  &  $3.9\times10^{9}$  &  146  &  0.047  &  \checkmark  &  \cite{El-Badry2018a}    \\
m11b  &  0.26  &  $4.4\times10^{10}$  &  $1.2\times10^{8}$  &  92.4  &  0.12  &    &  \cite{Chan2018}    \\
m12r  &  0.15  &  $1.0\times10^{12}$  &  $2.4\times10^{10}$  &  257  &  0.11  &  \checkmark  &  \cite{Samuel2020}    \\
m12z  &  0.037  &  $8.0\times10^{11}$  &  $2.5\times10^{10}$  &  242  &  0.052  &  \checkmark  &  \cite{Garrison-Kimmel2019a}    \\
m11i  &  0.014  &  $7.0\times10^{10}$  &  $1.0\times10^{9}$  &  106  &  0.013  &  \checkmark  &  \cite{El-Badry2018a}    \\
m11c  &  0.01  &  $1.4\times10^{11}$  &  $9.5\times10^{8}$  &  137  &  0.0068  &    &  \cite{Hopkins2018}    \\
m11e  &  0.0073  &  $1.5\times10^{11}$  &  $1.6\times10^{9}$  &  136  &  0.044  &  \checkmark  &  \cite{El-Badry2018a}    \\
m11d  &  0.0068  &  $2.9\times10^{11}$  &  $4.9\times10^{9}$  &  169  &  0.0026  &  \checkmark  &  \cite{El-Badry2018a}    \\
m11a  &  0.004  &  $4.1\times10^{10}$  &  $1.3\times10^{8}$  &  90.3  &  -0.022  &    &  \cite{Chan2018}    \\
m11q  &  0.0016  &  $1.5\times10^{11}$  &  $7.4\times10^{8}$  &  138  &  0.0045  &  \checkmark  &  \cite{Hopkins2018}    \\ %\hline
...
This hot accretion mode, in which the entire hot phase inflows, is qualitatively different from `precipitation' in which gas clumps cool at halo scales, loses buoyancy and subsequently accretes (e.g.~\citealt{Maller2004,Voit2017}).
The dominance of hot accretion over precipitation in MW-like galaxies simulated in FIRE has previously been noted by \cite{Esmerian2021}. 
...
This bar may explain the low $\fthin$ of this galaxy relative to its change in $f_{\rm aligned}$.
...
Note that the ratio of the total $j_z/\vert j \vert$ is not identical to unity because the $z$ direction is with respect to the central galaxy rather than the gas itself.
...
This appears to be inconsistent with the \cite{Stevens2017}, which found a $\gtrsim50$\% decrease in $j_z$ when accreting hot gas cools.
...
The accretion attains significant angular momentum support as it proceeds through the inner CGM, consistent with other analyses of CGM rotational support which find that rotation support is more prominent at smaller CGM radii~\citep{Oppenheimer2018, Trapp2021}.
...
Any angular momentum gained is expected to be lost by other particles, driving inflow of existing gas particles in the disk or disk-halo interface~\citep[e.g.][]{Mayor1981, Pezzulli2016a}.
We note that the median increase in $j_z$ upon accretion and cooling in the simulated galaxy shown in Fig.~\ref{f: before and after B} is similar to the observed $30\%$ difference between the rotation velocity of the the Milky Way disk and its hot CGM \citep{Hodges-Kluck2016}.
...
Note that star formation occurs despite that the 84th density percentile after cooling is $\approx10$ cm$^{-3}$, well below the minimum density for star formation of $n_{\rm SF} = 1000$ cm$^{-3}$ in FIRE, since gas remains at densities approaching $n_{\rm SF}$ only for a short time before forming stars.
...
This balance between radiative cooling and compressive heating is not possible with a hydrostatic halo --- without inward movement compression will not occur.
...
\begin{figure*}
    ...
    \caption{
    The on-sky evolution of the direction of angular momentum for gas accreting onto a MW-like galaxy, \texttt{m12i}.
    ...
    The angles $\theta$ and $\phi$ are spherical coordinates with $\theta$ relative to the $z$-direction, i.e. $\theta=0^\circ$ in the center of the projection points in the direction of the galaxy angular momentum at $z=0$.
    The black point outlined in white is the direction of the net angular momentum vector of accreting gsd, $\vec L$.
...
% Coherence
Figure~\ref{f: coherence -- on sky} shows the evolution of angular momentum distribution for \texttt{m12i}.
In particular we show the ``on-sky'' azimuthal equidistant projection of the angular momentum direction for \texttt{m12i}.
Azimuthal equidistant projections preserve the distance to the central point (located at $j_z / \vert j \vert = 1$) as well as the orientation ($\phi$) relative to the central point.
...
Prior to $t - \tcools = -500$ Myrs accretion is composed of gas rotating in a variety of directions, including counter-rotating ($j_z/\vert j \vert < 0$ or equivalently $\theta > 90^\circ$.
Nevertheless, as a whole the accreting gas distribution is roughly centered on the angular momentum of the galaxy at $z=0$, $\theta = 0^\circ$.
By $t - \tcools = -50$ Myrs the angular momentum distribution is significantly more coherent/narrower, with only a minor change in the direction of $\vec L$.
...
We see this explicitly for cold-mode accretion in our low-mass galaxies (e.g. Figs~\ref{f: before and after combined} and~\ref{f: m11d}).
...
\begin{figure*}
    ...
    % Post-submission to-do: try fitting a logit function to f vs tcool/tff.
    }
...
% Precipitation
There are some key differences between the hot CGM in the FIRE simulations and precipitation-mode accretion, as explored by previous work~\citep[e.g.][]{Esmerian2021, Stern2021}.
\cite{Esmerian2021} showed typically only satellite galaxies and their CGM produce sufficiently large density perturbations for cool clouds to form.
This is explained by $t_{\rm cool}/t_{\rm flow} \sim 1-100$ in the inflowing hot CGM, i.e. gas accretes onto the galaxy faster than a cooling instability spontaneously develops~\citep{Balbus1989}.
This explanation is consistent with idealized simulations of cooling-flow CGMs show density perturbations of order $\delta \rho / \rho \sim 0.1$ do not lead to cooling~\citep[][]{Stern2019}.
Further, \cite{Esmerian2021} show that cooling out of the hot halo via perturbation is a poor predictor for whether or not the gas will accrete onto the galaxy, i.e. become precipitation-mode accretion.
We note, however, that the FIRE simulations likely under-resolve cooling or mixing of already-cool gas with lengthscales $\sim c_{\rm s} t_{\rm cool} \sim 0.1$ pc~\citep[e.g.][]{McCourt2018, Mandelker2019a, Gronke2020b, Fielding2020, Mandelker2021}.

\cite{Sormani2018} recently considered the effect of angular momentum support on the structure of a hot CGM which is hydrostatic except for the rotation component (as did \citealt{Pezzulli2017}).
...
\textbf{JS: May be better to remove this since other velocity components are significant relative to $v_\phi$ (also in analytic model).}
% Precipitation
...
\section{Definition of thin disk fraction}
...
\begin{figure}
    \centering
    \includegraphics[width=\columnwidth]{figures/prevalence/thin_disk_fracs.pdf}
    \caption{
    Thin disk fraction used in the current manuscript minus the thin disk fraction used in a prior version, which included an error.
    Solid points show the difference between the prior version and our current definition of thin disk as $j_z/j_c(E) > 0.9$, while empty points show the difference between the prior version and a thin disk cut of $j_z/j_c(E) > 0.8$.
    The values of the prior thin disk fraction are consistent with the values of the thin disk fraction used in the current manuscript.
    }
    \label{f: corrected v uncorrected}
\end{figure}
...
% Thin disk fraction error
A previous version of this manuscript had a physical kpc to comoving kpc/h conversion error.
As such, $j_c(E)$ for each particle was incorrectly calculated using $\approx 2\times$ the actual galactocentric distance of the particle, $j_c(E_{\rm prior}) = j_c(E(R/h^2))$, where $h \approx 0.702$ is the Hubble parameter.
The consequence was that fewer stars were considered thin disk for a given cut on $j_z/j_c(E)$.
Figure~\ref{f: corrected v uncorrected} compares the prior version of the thin disk fraction to the current version.
In the prior version of the manuscript we used a less conservative cut on which stars were considered thin disk, $j_z/j_c(E_{\rm prior}) > 0.8$.
The fraction of stars with $j_z/j_c(E) > 0.8$ can be up to $\sim 0.1 - 0.25$ higher than the fraction with $j_z/j_c(E_{\rm prior}) > 0.8$.
However, the fraction of stars in a thin disk using the current criteria of $j_z/j_c(E) > 0.9$ is within $\lesssim 0.08$ of the fraction of stars in a thin disk using $j_z/j_c(E_{\rm prior}) > 0.8$.
To rephrase, the results in our previous manuscript are quantitatively consistent with the results in our current manuscript but with a more conservative cut on $j_z/j_c(E)$.
...
\section{Comparison to common metrics of galaxy and halo spin}
...
\begin{figure*}
    ...
    \caption{
    Fraction of young stars in a thin disk versus spin parameter $\lambda$, ratio of mean specific angular momentum of thin disk stars to that of the dark matter halo, ratio of mean specific angular momentum of all stars to that of the dark matter halo, and change in alignment of accreting gas (see Figure~\ref{f: prevalence}).
    The last panel traces prevalence of rotating cooling flows, and correlates most strongly with thin disk fraction.
    \textbf{Use consistent limits for middle panels.}
    }
    \label{f: prevalence vs j properties}
\end{figure*}

% Figure description
Figure~\ref{f: prevalence vs j properties} compares the frequency of thin disks to some common metrics of angular momentum properties.
We see no correlation between thin disk fraction and spin parameter, $\lambda \equiv j_{\rm DM} / ( \sqrt(2) r_{\rm vir} v_c(r_{\rm vir})$~\cite{Bullock2001}.
